...
public class registeredStudents extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select * from student"); // This will be null if there is no roll no is regestered inside the student table...
            
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            // DbUtils set the table size accordigs to the no of columns automatically...
            // now we dont need to do anything...
        } catch(Exception e) {
